    ...
    return (
        <div>
            <section id="video" className="position-relative overflow-hidden">
                ...
                <img className="position-absolute top-50 start-50 translate-middle z-n1 d-md-none h-100" src="https://images.pexels.com/photos/5731861/pexels-photo-5731861.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="Imagen Principal Mobile" />
